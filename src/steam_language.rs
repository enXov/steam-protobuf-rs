// This file is auto-generated by steam-language-gen.
...
pub enum EMsg {
    ...
    ProtobufWrapped = 2,
    BaseGeneral = 100,
    // GenericReply = 100 (alias for BaseGeneral)
    DestJobFailed = 113,
    Alert = 115,
    SCIDRequest = 120,
    SCIDResponse = 121,
    ...
    BaseShell = 200,
    // AssignSysID = 200 (alias for BaseShell)
    Exit = 201,
    DirRequest = 202,
    DirResponse = 203,
    ZipRequest = 204,
    ...
    BaseGM = 300,
    // Heartbeat = 300 (alias for BaseGM)
    ShellFailed = 301,
    ExitShells = 307,
    ExitShell = 308,
    ...
    BaseVS = 600,
    // ReqChallenge = 600 (alias for BaseVS)
    VACResponse = 601,
    ...
    BaseAdmin = 1000,
    // AdminCmd = 1000 (alias for BaseAdmin)
    ...
    AdminMsgSpew = 1028,
    BaseFBS = 1100,
    // FBSReqVersion = 1100 (alias for BaseFBS)
    FBSVersionInfo = 1101,
    ...
    BaseFileXfer = 1200,
    // FileXferRequest = 1200 (alias for BaseFileXfer)
    FileXferResponse = 1201,
    FileXferData = 1202,
    FileXferEnd = 1203,
    FileXferDataAck = 1204,
    BaseChannelAuth = 1300,
    // ChannelAuthChallenge = 1300 (alias for BaseChannelAuth)
    ...
    BaseTest = 3000,
    // FailServer = 3000 (alias for BaseTest)
    ...
    DRMRange2 = 7600,
    // CEGVersionSetEnableDisableRequest = 7600 (alias for DRMRange2)
    ...
    RMRange = 7800,
    // RMTestVerisignOTP = 7800 (alias for RMRange)
    ...
    UGSBase = 7900,
    // UGSUpdateGlobalStats = 7900 (alias for UGSBase)
    ClientUGSGetGlobalStats = 7901,
    ClientUGSGetGlobalStatsResponse = 7902,
    StoreBase = 8000,
    UMQBase = 8100,
    // UMQLogonRequest = 8100 (alias for UMQBase)
    ...
    WorkshopBase = 8200,
    WebAPIBase = 8300,
    // WebAPIValidateOAuth2Token = 8300 (alias for WebAPIBase)
    ...
    SecretsBase = 8600,
    // SecretsRequestCredentialPair = 8600 (alias for SecretsBase)
    SecretsCredentialPairResponse = 8601,
    BoxMonitorBase = 8700,
    // BoxMonitorReportRequest = 8700 (alias for BoxMonitorBase)
    BoxMonitorReportResponse = 8701,
    LogsinkBase = 8800,
    // LogsinkWriteReport = 8800 (alias for LogsinkBase)
    PICSBase = 8900,
    ...
    WorkerProcess = 9000,
    // WorkerProcessPingRequest = 9000 (alias for WorkerProcess)
    WorkerProcessPingResponse = 9001,
    WorkerProcessShutdown = 9002,
    DRMWorkerProcess = 9100,
    // DRMWorkerProcessDRMAndSign = 9100 (alias for DRMWorkerProcess)
    ...
    // TestWorkerProcessLoadUnloadModuleRequest = 9200 (alias for TestWorkerProcess)
    ...
    SLCBase = 9400,
    // SLCUserSessionStatus = 9400 (alias for SLCBase)
    ...
    // RemoteClientAuth (alias for RemoteClientBase, obsolete)
    #[deprecated]
    ...
    // ClientPlayingSessionState = 9600 (alias for ClientConcurrentSessionsBase)
    ClientKickPlayingSession = 9601,
    ClientBroadcastBase = 9700,
    // ClientBroadcastInit = 9700 (alias for ClientBroadcastBase)
    ClientBroadcastFrames = 9701,
    ClientBroadcastDisconnect = 9702,
    ClientBroadcastScreenshot = 9703,
    ClientBroadcastUploadConfig = 9704,
    BaseClient3 = 9800,
    // ClientVoiceCallPreAuthorize = 9800 (alias for BaseClient3)
    ...
    // ClientLANP2PRequestChunk = 9900 (alias for ClientLANP2PBase)
    ...
    // NotifyWatchdog = 10000 (alias for BaseWatchdogServer)
    ClientSiteLicenseBase = 10100,
    // ClientSiteLicenseSiteInfoNotification = 10100 (alias for ClientSiteLicenseBase)
    ...
    // ChatServerGetPendingNotificationCount = 12000 (alias for BaseChatServer)
    ChatServerGetPendingNotificationCountResponse = 12001,
    BaseSecretServer = 12100,
    // ServerSecretChanged = 12100 (alias for BaseSecretServer)
    BaseWG = 12200,
    // WGConnectionProtocolError = 12200 (alias for BaseWG)
...
impl EMsg {
    pub const GenericReply: Self = Self::BaseGeneral;
    pub const AssignSysID: Self = Self::BaseShell;
    pub const Heartbeat: Self = Self::BaseGM;
    pub const ReqChallenge: Self = Self::BaseVS;
    pub const AdminCmd: Self = Self::BaseAdmin;
    pub const FBSReqVersion: Self = Self::BaseFBS;
    pub const FileXferRequest: Self = Self::BaseFileXfer;
    pub const ChannelAuthChallenge: Self = Self::BaseChannelAuth;
    pub const FailServer: Self = Self::BaseTest;
    pub const CEGVersionSetEnableDisableRequest: Self = Self::DRMRange2;
    pub const RMTestVerisignOTP: Self = Self::RMRange;
    pub const UGSUpdateGlobalStats: Self = Self::UGSBase;
    pub const UMQLogonRequest: Self = Self::UMQBase;
    pub const WebAPIValidateOAuth2Token: Self = Self::WebAPIBase;
    pub const SecretsRequestCredentialPair: Self = Self::SecretsBase;
    pub const BoxMonitorReportRequest: Self = Self::BoxMonitorBase;
    pub const LogsinkWriteReport: Self = Self::LogsinkBase;
    pub const WorkerProcessPingRequest: Self = Self::WorkerProcess;
    pub const DRMWorkerProcessDRMAndSign: Self = Self::DRMWorkerProcess;
    pub const TestWorkerProcessLoadUnloadModuleRequest: Self = Self::TestWorkerProcess;
    pub const SLCUserSessionStatus: Self = Self::SLCBase;
    pub const RemoteClientAuth: Self = Self::RemoteClientBase;
    pub const ClientPlayingSessionState: Self = Self::ClientConcurrentSessionsBase;
    pub const ClientBroadcastInit: Self = Self::ClientBroadcastBase;
    pub const ClientVoiceCallPreAuthorize: Self = Self::BaseClient3;
    pub const ClientLANP2PRequestChunk: Self = Self::ClientLANP2PBase;
    pub const NotifyWatchdog: Self = Self::BaseWatchdogServer;
    pub const ClientSiteLicenseSiteInfoNotification: Self = Self::ClientSiteLicenseBase;
    pub const ChatServerGetPendingNotificationCount: Self = Self::BaseChatServer;
    pub const ServerSecretChanged: Self = Self::BaseSecretServer;
    pub const WGConnectionProtocolError: Self = Self::BaseWG;
}
...
/// Steam enum `EFriendRelationship`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
pub enum EClanPermission {
    ...
    NonMember = 128,
    MemberAllowed = 128 | 4,
    ModeratorAllowed = 128 | 4 | 8,
    OfficerAllowed = 128 | 4 | 8 | 2,
    OwnerAllowed = 128 | 4 | 8 | 2 | 1,
    // Anybody = 128 | 4 | 8 | 2 | 1 (alias for OwnerAllowed)
}

impl EClanPermission {
    pub const Anybody: Self = Self::OwnerAllowed;
}

/// Bitflag enum `EChatPermission`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
pub enum EChatPermission {
    ...
    Ban = 256,
    ChangeAccess = 512,
    // EveryoneNotInClanDefault = 8 (alias for Talk)
    EveryoneDefault = 8 | 2,
    MemberDefault = 256 | 16 | 8 | 2,
    // OfficerDefault = 256 | 16 | 8 | 2 (alias for MemberDefault)
    OwnerDefault = 512 | 256 | 64 | 32 | 16 | 8 | 2 | 1,
    Mask = 1019,
}

impl EChatPermission {
    pub const EveryoneNotInClanDefault: Self = Self::Talk;
    pub const OfficerDefault: Self = Self::MemberDefault;
}

/// Bitflag enum `EFriendFlags`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Bitflag enum `EPersonaStateFlag`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Bitflag enum `EClientPersonaStateFlag`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Steam enum `EPurchaseResultDetail`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Steam enum `EAuthSessionResponse`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Steam enum `EChatRoomEnterResponse`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
impl EAppInfoSection {
    pub const Common: Self = Self::First;
}

/// Steam enum `EContentDownloadSourceType`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
pub enum EOSType {
    ...
    Linux7x = -183,
    Linux510 = -182,
    // LinuxMax = -101 (alias for MacOS104)
    WinUnknown = 0,
    Win311 = 1,
    Win95 = 2,
    Win98 = 3,
...
impl EOSType {
    pub const MacOSMax: Self = Self::Unknown;
    pub const LinuxMax: Self = Self::MacOS104;
}

/// Steam enum `EServerType`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
impl EServerType {
    pub const Shell: Self = Self::First;
}

/// Steam enum `EBillingType`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Steam enum `EActivationCodeClass`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(u32)]
...
/// Bitflag enum `EChatMemberStateChange`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Steam enum `EWorkshopEnumerationType`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Steam enum `EPublishedFileVisibility`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Steam enum `EWorkshopFileType`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
pub enum EWorkshopFileType {
    First = 0,
    // Community = 0 (alias for First)
    Microtransaction = 1,
    Collection = 2,
    Art = 3,
    Video = 4,
...
impl EWorkshopFileType {
    pub const Community: Self = Self::First;
}

/// Steam enum `EWorkshopFileAction`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Bitflag enum `EMarketingMessageFlags`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Bitflag enum `ERemoteStoragePlatform`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Bitflag enum `EDRMBlobDownloadType`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Steam enum `EDRMBlobDownloadErrorDetail`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Steam enum `EClientStatAggregateMethod`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Steam enum `ELeaderboardDataRequest`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Steam enum `ELeaderboardSortMethod`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Steam enum `ELeaderboardDisplayType`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Steam enum `ELeaderboardUploadScoreMethod`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Bitflag enum `EUCMFilePrivacyState`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Steam enum `EPublishedFileQueryType`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Steam enum `EPublishedFileInappropriateProvider`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Steam enum `EPublishedFileInappropriateResult`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Steam enum `EChatroomNotificationLevel`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Steam enum `EChatRoomMemberStateChange`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Bitflag enum `EChatRoomGroupPermissions`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Steam enum `EChatRoomGroupAction`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Steam enum `ETradeOfferConfirmationMethod`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Steam enum `ELobbyDistanceFilter`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Steam enum `ESteamIPv6ConnectivityProtocol`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Steam enum `ESteamIPv6ConnectivityState`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
...
/// Steam enum `EGamingDeviceType`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
pub enum EGamingDeviceType {
    Unknown = 0,
    StandardPC = 1,
    ConsoleLegacy = 256,
    PS3 = 273,
...
/// Steam enum `EMobileConfirmationAction`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
pub enum EMobileConfirmationAction {
    None = 0,
    Allow = 1,
    Cancel = 2,
}

/// Steam enum `EMobileConfirmationType`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
pub enum EMobileConfirmationType {
    Invalid = 0,
    Test = 1,
    Trade = 2,
    MarketListing = 3,
...
/// Steam enum `ECommentPermission`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
pub enum ECommentPermission {
    Invalid = -1,
    FriendsOnly = 0,
    Anyone = 1,
    SelfOnly = 2,
...
/// Steam enum `ECommunityPrivacy`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(i32)]
pub enum ECommunityPrivacy {
    Invalid = 0,
    Private = 1,
    FriendsOnly = 2,
    Public = 3,
